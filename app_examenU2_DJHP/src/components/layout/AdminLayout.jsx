        ...
        <Navbar fluid rounded style={{backgroundColor:"paleturquoise"}}>
          ...
          <div className="flex md:order-2">
            <Dropdown
              ...
              inline
              label={
                <Avatar alt="User settings" img="https://www.ambientum.com/wp-content/uploads/2019/11/pino-laricio-696x464.jpg" rounded />
              }
            >
              <Dropdown.Header>
                <span className="block text-sm">Pino Cosmico</span>
